...
const TableNameCAdmin = "ms_c_admin"
...
type CAdmin struct {
	...
	Status       int8   `gorm:"column:status;type:tinyint unsigned;not null;comment:状态 1：正常 2：禁用" json:"status"`      // 状态 1：正常 2：禁用
...
// TableName CAdmin's table name
func (*CAdmin) TableName() string {
	return TableNameCAdmin
}
