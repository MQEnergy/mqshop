...
func configDevYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config.dev.yaml", size: 1132, mode: os.FileMode(420), modTime: time.Unix(1660871428, 0)}
...
func configProdYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config.prod.yaml", size: 1134, mode: os.FileMode(420), modTime: time.Unix(1660871454, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func configTestYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config.test.yaml", size: 1131, mode: os.FileMode(420), modTime: time.Unix(1660871404, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
