...
╚██████╔╝██║██║ ╚████║      ██║     ██║  ██║██║  ██║██║ ╚═╝ ██║███████╗╚███╔███╔╝╚██████╔╝██║  ██║██║  ██╗
 ╚═════╝ ╚═╝╚═╝  ╚═══╝      ╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚══════╝ ╚══╝╚══╝  ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝
```
[![GoDoc](https://godoc.org/github.com/MQEnergy/mqshop/?status.svg)](https://pkg.go.dev/github.com/MQEnergy/mqshop)
[![Go Report Card](https://goreportcard.com/badge/github.com/MQEnergy/mqshop)](https://goreportcard.com/report/github.com/MQEnergy/mqshop)
[![codebeat badge](https://codebeat.co/badges/1bf7dd49-1283-4ec9-b56e-a755e1e9c8dd)](https://codebeat.co/projects/github-com-mqenergy-mqshop-main)
[![GitHub license](https://img.shields.io/github/license/MQEnergy/mqshop)](https://github.com/MQEnergy/mqshop/blob/main/LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/MQEnergy/mqshop)](https://github.com/MQEnergy/mqshop/stargazers)
...
- [x] 支持 [controller、service](https://github.com/MQEnergy/mqshop/tree/main/command) 命令行方式生成代码工具
...
- [x] 支持 [casbin](https://github.com/casbin/casbin) rbac权限 集成于中间件中 [casbin_auth.go](https://github.com/MQEnergy/mqshop/blob/main/middleware/casbin_auth.go)
- [x] 支持 [requestId](https://github.com/gin-contrib/requestid) 中间件 实现了方便链路追踪日志记录中间件 [requestid_auth.go](https://github.com/MQEnergy/mqshop/blob/main/middleware/requestid_auth.go)
...
- [x] 实现 ip白名单配置 集成于中间件中 [ip_auth.go](https://github.com/MQEnergy/mqshop/blob/main/middleware/ip_auth.go)
- [x] 实现 [ticker](https://github.com/MQEnergy/mqshop/blob/main/pkg/util/ticker.go) 定时器组件 
- [x] 实现 基于gorm的 [pagination](https://github.com/MQEnergy/mqshop/blob/main/pkg/paginator/pagination.go) 分页构造器组件
- [x] 实现 [code](https://github.com/MQEnergy/mqshop/tree/main/pkg/response/code.go) 统一定义的返回码，[exception](https://github.com/MQEnergy/mqshop/tree/main/pkg/response/exception.go) 统一错误返回处理组件
...
```go
import "github.com/MQEnergy/mqshop/pkg/paginator"
```
...
```bash
go mod init github.com/MQEnergy/mqshop
go mod tidy
```
