...
-- ----------------------------
-- Table structure for ms_attachment
-- ----------------------------
...
-- ----------------------------
-- Table structure for ms_auth_resource
-- ----------------------------
DROP TABLE IF EXISTS `ms_auth_resource`;
CREATE TABLE `ms_auth_resource` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for ms_auth_role
-- ----------------------------
DROP TABLE IF EXISTS `ms_auth_role`;
CREATE TABLE `ms_auth_role` (
...
-- ----------------------------
-- Table structure for ms_auth_role_permission
-- ----------------------------
DROP TABLE IF EXISTS `ms_auth_role_permission`;
CREATE TABLE `ms_auth_role_permission` (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for ms_casbin_rule
-- ----------------------------
DROP TABLE IF EXISTS `ms_casbin_rule`;
CREATE TABLE `ms_casbin_rule` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_ms_casbin_rule` (`ptype`,`v0`,`v1`,`v2`,`v3`,`v4`,`v5`),
