...
-- ----------------------------
-- Table structure for ms_c_admin
-- ----------------------------
DROP TABLE IF EXISTS `ms_c_admin`;
CREATE TABLE `ms_c_admin` (
...
-- ----------------------------
-- Table structure for ms_c_attachment
-- ----------------------------
DROP TABLE IF EXISTS `ms_c_attachment`;
CREATE TABLE `ms_c_attachment` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for ms_c_resource
-- ----------------------------
DROP TABLE IF EXISTS `ms_c_resource`;
CREATE TABLE `ms_c_resource` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for ms_c_role
-- ----------------------------
DROP TABLE IF EXISTS `ms_c_role`;
CREATE TABLE `ms_c_role` (
...
-- ----------------------------
-- Table structure for ms_c_role_auth
-- ----------------------------
DROP TABLE IF EXISTS `ms_c_role_auth`;
CREATE TABLE `ms_c_role_auth` (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for ms_c_casbin_rule
-- ----------------------------
DROP TABLE IF EXISTS `ms_c_casbin_rule`;
CREATE TABLE `ms_c_casbin_rule` (
